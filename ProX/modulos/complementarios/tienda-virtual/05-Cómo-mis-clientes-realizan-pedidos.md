...
Luego añade el producto que deseas comprar, seleccionando el botón azul de Añadir al carrito [🛒].

![Alt text](img/2_realizarpedidos_34.jpg)
...
![Alt text](img/9_realizarpedidos__344.jpg)
...
![Alt text](img/9_realizarpedidos___34.jpg)
...
En esta sección se visualizará el total de la compra 

![Alt text](img/9_realizarpedidos_231.jpg)

Posteriormente,  para realizar el pago, se deberá seleccionar el método de pago correspondiente. 

![Alt text](img/9_realizarpedid23_231.jpg)

Luego aparecerá un mensaje de **confirmación de pago exitoso**.

![Alt text](img/9_realizarpedidos.jpg)

Para aprender a gestionar las verificaciones de pago en los pedidos realizados por el cliente, te invitamos a leer nuestro artículo **[Gestionar pedido](https://fastura.github.io/documentacion/Pro-X/Tienda-Virtual/Pedidos)**.
