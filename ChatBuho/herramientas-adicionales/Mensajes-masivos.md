...
Para obtener los datos del API de WhatsApp, previamente debes tener creado el app y agregado el número celular, para saber como crearlo, visita el siguiente **[artículo](../whatsapp-api-facebook/Pasos-para-la-integracion-de-WhatsApp-API.md)**.
 ...
 * Crea tu plantilla de WhatsApp, viendo este **[artículo](../mas-articulos/Plantillas-para-mensajes-masivos.md)**.
